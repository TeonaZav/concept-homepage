          ...
          <div class="${styles.contentWrapper}"> 
           ...
           <figure class="${styles.bankingImage}">
            ...
            <div class="${styles.storeButtons}">
              <a href="https://play.google.com/store/apps/details?id=com.icomvision.bsc.tbc&hl=en" class="${styles.storeButton}">
              </a>
              <a href="https://apps.apple.com/us/app/tbc-bank/id766598432" class="${styles.storeButton}">
              </a>
            </div>
          </div>
        </div>
